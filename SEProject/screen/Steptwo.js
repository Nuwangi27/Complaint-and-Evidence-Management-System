...
export default function App() {
  ...
  <>
          ...
          <TextInput
            ...
            style={{ borderWidth: 1, borderColor: 'gray', padding: 10, marginTop: 10, color: 'white' }}
          />
        ...
        <TouchableOpacity onPress={() => toggleSection('incidentDetails')} style={styles.sectionHeader}>
  ...
  <>
              ...
              <TextInput
                ...
                style={{ borderWidth: 1, borderColor: 'gray', padding: 10, marginTop: 10 }}
              />
              <Text style={{color: COLORS.white }}>Where did it happend?:</Text>
          <TextInput
            placeholder="Where did it happen"
            style={{ borderWidth: 1, borderColor: 'gray', padding: 60, marginTop: 20 }}
          />
            <Text style={{color: COLORS.white }}>Upload Evidence(images or videos):</Text>
          <TextInput
            placeholder="Upload images & videos"
            style={{ borderWidth: 1, borderColor: 'gray', padding: 40, marginTop: 20 }}
          />
            <Text style={{color: COLORS.white }}>Insident Location:</Text>
          <TextInput
            placeholder="insident Location"
            style={{ borderWidth: 1, borderColor: 'gray', padding: 40, marginTop: 20 ,marginBottom: 20,}}/>
            </>
          </ScrollView>
        )}

        <View style={styles.dropdownContainer}>
          <TouchableOpacity onPress={toggleDepartmentDropdown} style={styles.dropdownHeader}>
          ...
          {showDepartmentDropdown && (
            <MultipleSelectList
              ...
              data={data}
              label="Departments"
              onSelect={() => console.log('Departments selected:', selectedDepartments)}
              save="value"
